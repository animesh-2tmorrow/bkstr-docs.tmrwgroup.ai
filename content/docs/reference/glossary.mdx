...
Short definitions for the terms used across bkstr's docs. For the model behind them, see [Concepts](/docs/reference/concepts).
...
**API key** — A `bks_`-prefixed secret that authenticates API and CLI requests. Created and revoked at [/dashboard/api-keys](https://bkstr.tmrwgroup.ai/dashboard/api-keys); shown in full only once.
...
**Catalog** — The set of active books and skills, browsable at [/storefront](https://bkstr.tmrwgroup.ai/storefront).
...
**Library** — Your dashboard view of owned and browsable items, at [/dashboard/library](https://bkstr.tmrwgroup.ai/dashboard/library).
...
**Storefront** — The public catalog at [/storefront](https://bkstr.tmrwgroup.ai/storefront).
