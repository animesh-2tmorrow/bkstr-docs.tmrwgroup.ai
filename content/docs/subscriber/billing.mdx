---
title: "Billing"
description: "One-time purchases, the billing page, receipts, and test mode."
---
...
[/dashboard/billing](https://bkstr.tmrwgroup.ai/dashboard/billing) is your payment history.
...
For how a purchase becomes an owned item, see [Getting started](/docs/subscriber/getting-started); for the per-item view, see [Your library](/docs/subscriber/your-library). Publishers pricing their own items should read [Pricing](/docs/publisher/pricing).
